    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_title', models.TextField(default='Duis consequat dui nec nisi volutpat eleifend.', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='HeroSection',
            fields=[
                ...
                ('title1', models.CharField(default='Imperdiet sit', max_length=20)),
                ('title2', models.CharField(default='Vestibulum quis', max_length=20)),
                ('title3', models.CharField(default='Penatibus in', max_length=20)),
                ('text1', models.CharField(default='Vestibulum ac est lacinia nisi venenatis tristique. integer a nibh.', max_length=200)),
                ('text2', models.CharField(default='Maecenas tincidunt lacus at velit. aliquam sit amet diam in magna bibendum imperdiet.', max_length=200)),
                ('text3', models.CharField(default='Integer tincidunt ante vel ipsum. curabitur at ipsum ac tellus semper interdum.', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='MainOptions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_title', models.TextField(default='Donec vitae nisi.', max_length=200)),
                ('text1', models.TextField(default='Aenean sit amet justo. aliquam non mauris. aenean lectus. maecenas ut massa quis augue luctus tincidunt. morbi porttitor lorem id ligula. proin eu mi. morbi ut odio. cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.', max_length=800)),
                ('text2', models.TextField(default='Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. duis bibendum. aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem. quisque ut erat. sed vel enim sit amet nunc viverra dapibus. maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. vivamus in felis eu sapien cursus vestibulum. nullam molestie nibh in lectus. maecenas rhoncus aliquam lacus.', max_length=800)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.CharField(default='Nulla tempus. fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus. vestibulum quam sapien, varius ut, blandit non, interdum in, ante. aenean fermentum.', max_length=800)),
