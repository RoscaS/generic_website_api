...
ALLOWED_HOSTS = ['.jura-coiffure.ch']
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='postmaster@mg.jura-coiffure.ch')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD')
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=True, cast=bool)

DEFAULT_FROM_EMAIL = f"{WEBSITE_DATA['NAME'].strip('.')} <noreply@jura-coiffure.ch>"
EMAIL_SUBJECT_PREFIX = f"{WEBSITE_DATA['PROJECT_NAME']}: "
EMAIL_SEND_TO = ['jura.coiffure@gmail.com']
